...
$(document).ready(function() {
    ...
    // DEMO ONLY
    var colorStyles = jQuery(
        '<div id="demo-changer">'+
        '<div class="changer">'+
        '<ul>'+ 
        '<li><a href="#" id="gt-pink"></a></li>'+
        '<li><a href="#" id="gt-blue"></a></li>'+
        '<li><a href="#" id="gt-cyan"></a></li>'+
        '<li><a href="#" id="gt-green"></a></li>'+
        '<li><a href="#" id="gt-orange"></a></li>'+
        '<li><a href="#" id="gt-purple"></a></li>'+
        '<li><a href="#" id="gt-red"></a></li>'+
        '<li><a href="#" id="gt-yellow"></a></li>'+
        '<li><a href="https://themeforest.net/item/noyre-a-dark-one-page-creative-template/23285031" id="gt-buy"><i class="fa fa-shopping-bag"></i></a></li>'+
        '</ul>'+
        '</div></div>'
    );
